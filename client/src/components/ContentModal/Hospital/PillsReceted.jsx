	...
	return (
		<div className="flex sm:flex-col md:flex-row lg:flex-row justify-between w-full gap-5">
			<div className="bg-zinc-100 sm:w-full md:w-[50%] lg:w-[50%] p-2">
		    	...
		    	<ScrollShadow hideScrollBar className="sm:h-[550px] md:h-[400px] lg:h-[300px]">
					<div className="mb-2">
						<p className="text-xl text-blue-500 flex-col">Fluoxetina</p>
						<Chip className="capitalize" color="primary" size="sm" variant="flat">30 tablets</Chip>
						<p className="flex-col text-sm">It is used to treat depression, obsessive-compulsive disorder, and bulimia nervosa, among others.</p>
					</div>
			...
			<div className="bg-zinc-100 sm:w-full md:w-[50%] lg:w-[50%] p-2">
		    	...
		    	<ScrollShadow hideScrollBar className="sm:h-[550px] md:h-[400px] lg:h-[300px]">
					<div className="mb-2">
						...
						<Chip className="capitalize" color="primary" size="sm" variant="flat">30 tablets</Chip>
						<p className="text-sm">It is used to treat depression in adults and generalized anxiety disorder.</p>
					</div>
